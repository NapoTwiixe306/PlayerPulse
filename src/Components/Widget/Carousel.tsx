    ...
    <>
      <div className="logos">
        <div className="logos-slide">
          <Image
            src={alpha}
            alt="rocket league icons"
            onClick={() => handleCreateSlugAndRedirect("Alpha")}
          />
          <Image
            src={rado}
            alt="rocket league icons"
            onClick={() => handleCreateSlugAndRedirect("Rado")}
          />
          <Image
            src={zen}
            alt="rocket league icons"
            onClick={() => handleCreateSlugAndRedirect("Zen")}
          />
          <Image
            src={vati}
            alt="rocket league icons"
            onClick={() => handleCreateSlugAndRedirect("Vatigoat")}
          />
          <Image
            src={exo}
            alt="rocket league icons"
            onClick={() => handleCreateSlugAndRedirect("Exo")}
          />
          <Image
            src={extra}
            alt="rocket league icons"
            onClick={() => handleCreateSlugAndRedirect("Extra")}
          />
          <Image
            src={kaydop}
            alt="rocket league icons"
            onClick={() => handleCreateSlugAndRedirect("Kaydop")}
          />
        </div>
        <div className="logos-slide">
          <Image
